...
@implementation FirstHttpTools_OpenCenter

static AFHTTPRequestOperationManager *manager;
static FirstHttpTools_OpenCenter *httpTools;

static NSString *baseUrl;
static NSString *content;

//GCD单例
+(FirstHttpTools_OpenCenter *)shareInstance
{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        httpTools = [[FirstHttpTools_OpenCenter alloc]init];
